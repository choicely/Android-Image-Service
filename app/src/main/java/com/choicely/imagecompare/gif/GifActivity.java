package com.choicely.imagecompare.gif;
...
//    private final String GIF_URL = "https://media.giphy.com/media/cE02lboc8JPO/giphy.gif";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView = findViewById(R.id.gif_web_view);
        image = findViewById(R.id.gif_image);
        frescoImage = findViewById(R.id.fresco_gif_image);
        text = findViewById(R.id.gif_text);
        glideCheck = findViewById(R.id.gif_glide_check);
        glideCheck.setOnClickListener(onProviderClick);
        frescoCheck = findViewById(R.id.gif_fresco_check);
        frescoCheck.setOnClickListener(onProviderClick);
        webCheck = findViewById(R.id.gif_web_view_check);
        webCheck.setOnClickListener(onProviderClick);
        loadingSpinner = findViewById(R.id.gif_loading_spinner);
