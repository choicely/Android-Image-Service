...
/**
 * Listener interface for lazy calls to {@link ImageService}.
 * 
 * @author tommy
 * 
 */
public interface ImageServiceListener {
	 ...
	 * 
	 * @param imageUrl
	 *            the image location string on the load that finished
	 * @param image
	 *            the result image, or <code>null</code> if one could not be
	 *            retrieved
	 * @param defaultResId
	 *            defaultResId an id of a resource to show as a "loading" image.
